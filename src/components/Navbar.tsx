  ...
  return (
    ...
    >
      <Container className="flex h-20 items-center justify-between">
        <a href="#home" className="font-serif italic text-2xl tracking-wide text-ink" onClick={() => setOpen(false)}>
          {restaurant.name}
        </a>
      ...
      <div
        className={`md:hidden fixed inset-0 top-20 bg-cream transition-transform duration-500 ease-out ${
